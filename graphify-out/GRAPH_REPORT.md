...
Cohesion: 0.02
Nodes (106): performance(), FeedbackSystem, Manages feedback on agent recommendations and tracks learning., Get performance metrics for a specific agent., Get performance metrics for all agents., Get all feedback for a specific decision., Get top-rated recommendations for an agent., Generate learning insights for an agent based on feedback. (+98 more)
...
- **Thin community `Community 17`** (1 nodes): `Construct AgentReport from LLM JSON response, mapping role-specific fields.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 18`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 19`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 20`** (1 nodes): `Create a temporary directory for testing.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
